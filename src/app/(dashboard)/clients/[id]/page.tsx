...
export default async function ClientDetailPage({
  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-4 sm:flex-row sm:items-start sm:justify-between sm:px-6">
        <div>
          <Link prefetch={false} href="/clients" className="text-sm text-gray-500 hover:underline">
            ← Clients
          </Link>
          <h1 className="mt-1 text-xl font-bold text-gray-900 break-words">{client.name}</h1>
        </div>
        <Link
          prefetch={false}
